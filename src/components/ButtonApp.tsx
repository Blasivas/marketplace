...
export function ButtonApp({ children, variant }: ButtonAppProps) {
  return <>
    <button className={classMerge(['flex rounded-xl w-68 h-[52px] action-md items-center justify-center place-content-between hover:cursor-pointer', variants.buttonApp[variant]])}>{children}</button>
  </>
}