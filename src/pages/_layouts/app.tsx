    ...
    <>
      <header className="h-20 p-5 flex justify-between border-b-1 border-b-shape">
        ...
        <nav className="flex gap-2">
          <Link
            to={'/app/dashboard'}
            data-current={pathname === '/app/dashboard'}
          ...
          >
            <HugeiconsIcon
              ...
              size={20}
              className="data-[current=false]:text-gray-300 data-[current=true]:group-hover:text-orange-dark
              data-[current=true]:text-orange-base"
            />
            Dashboard
          </Link>
          ...
          <Link
            to={'/app/produtos'}
            data-current={pathname === '/app/produtos'}
            className="flex gap-2 h-10 w-[140px] justify-center items-center rounded-xl action-sm group 
          hover:text-orange-dark hover:cursor-pointer text-gray-300
          data-[current=true]:bg-shape data-[current=true]:text-orange-base data-[current=true]:cursor-default"
          >
        ...
        <div className="flex gap-4">
          <Link
            to={'/app/novo-produto'}
            data-current={pathname === '/app/novo-produto'}
          >
      ...
      <div className="flex flex-col w-8/10 mx-auto mt-12 gap-10">
        <Outlet />
      </div>
    </>
  )
