...
export function Cadastro() {
  ...
  async function handleCadastro(data: CadastroForm) {
    try {
      ...
      toast.error(
        'Não foi possivel realizar o cadastro, verifique os dados informados',
      )
    }
  }
    ...
    <div className="flex flex-col gap-10 ">
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <label
            htmlFor="upload"
            className="flex h-[120px] w-[120px] bg-shape rounded-xl hover:cursor-pointer"
          >
            <HugeiconsIcon
              icon={ImageUploadIcon}
              size={32}
              className="text-orange-base m-auto"
            />
          </label>
          <input
            id="upload"
