...
import z from 'zod'
import { AccessIcon, Mail02Icon, ViewIcon, ViewOffIcon } from "@hugeicons/core-free-icons"
...
export function Login(){
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(handleLogin)} action="" className="flex flex-col mt-12">
        ...
        <label htmlFor='password' className="label-md text-gray-300 mt-5 focus-within:text-orange-base">SENHA
          <div className="flex border-b-gray-200 border-b-2 p-3 ">
            ...
            className="text-gray-200 mr-2 focus:text-orange-base invalid:text-danger"/>
            <input id='password' type={showPassword ? "text" : "password"}  placeholder='Sua senha de acesso' {...register('password')} className="body-md label-md text-gray-200 w-full"/>
