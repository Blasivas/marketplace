...
export function NovoProduto() {
  ...
  async function handleNovoProduto(data: NovoProdutoForm){
    try {
      ...
      toast.error('Não foi possivel criar o produto, verifique os dados informados')
    }
  }
  return (
    ...
    <title>Novo produto | Marketplace</title>
      <div className="flex flex-col items-start gap-2 w-[1030px]">
        ...
        <p className="body-sm text-gray-300">Cadastre um produto para venda no marketplace</p>
      </div>
        ...
        <div className="flex flex-col bg-white rounded-[20px] p-8 w-[591px] gap-8">
          ...
          <form onSubmit={handleSubmit(handleNovoProduto)} className="flex flex-col gap-5 ">
            ...
            <div className="flex gap-3 mt-5">
              ...
              <ButtonApp variant="orange" type="submit">Salvar e publicar</ButtonApp>
            </div>
          </form>
        </div>
      </div>
